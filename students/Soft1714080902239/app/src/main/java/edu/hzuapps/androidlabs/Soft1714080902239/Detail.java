...
import static edu.hzuapps.myapplication.MainActivity.TAG_INSERT;
import static edu.hzuapps.myapplication.MainActivity.TAG_UPDATE;
import static edu.hzuapps.myapplication.MainActivity.dbHelper;
import static edu.hzuapps.myapplication.MainActivity.getDbHelper;
            ...
            switch(item.getItemId()){
                case R.id.save:
                    if(tag==TAG_INSERT) {
                        ...
                        values.clear();
                        Toast.makeText(this, "保存啦！", Toast.LENGTH_SHORT).show();
                        finish();
                        break;
